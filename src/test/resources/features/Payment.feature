...
#    And User fills "123456" in "SMSCode" input field
  ...
  Scenario: View sale invoice details in cash inflow
    When User clicks "newCreditSale" page link
    And User clicks "productAreaExpandBtn" button
    And User fills "OLMAYAN STOK" in "productName" input field
    And User clicks "productSearchBtn" button
...
#    And User fills "123456" in "SMSCode" input field
    ...
    And User clicks "customerSearchBtn" button
    And User selects "641614" customer
    And User clicks "viewInvoiceDetailsBtn" button
    Then "Satış Fakturası" window should be displayed

  @ViewSaleInvoicePayments
  Scenario: View sale invoice payments in cash inflow
    When User clicks "newCreditSale" page link
    And User clicks "productAreaExpandBtn" button
    And User fills "OLMAYAN STOK" in "productName" input field
    And User clicks "productSearchBtn" button
...
#    And User fills "123456" in "SMSCode" input field
    ...
    And User clicks "customerSearchBtn" button
    And User selects "641614" customer
    And User clicks "viewInvoicePaymentsBtn" button
    Then "Fakturaya aid bütün ödənişlər tipləri" window should be displayed